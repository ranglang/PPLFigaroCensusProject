...
object Smokers {
  ...
  def main(args: Array[String]) {
    ...
    val alg2 = MetropolisHastings(20000, ProposalScheme.default, bob.smokes)
    alg2.start()
    println("Probability of Bob smoking: " + alg2.probability(bob.smokes, true))
    alg2.kill

    val alg3 = MetropolisHastings(20000, ProposalScheme.default, clara.smokes)
    alg3.start()
    println("Probability of Clara smoking: " + alg3.probability(clara.smokes, true))
    alg3.kill
  }
}
